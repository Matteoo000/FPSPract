...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Movement : MovementBehaviour
    {
        ...
        private void Jump()
        {
            ...
            // Add vertical force to the rigidbody to perform the jump.
            Velocity = new Vector3(Velocity.x, jumpForce, Velocity.z);
            // Set grounded to false to prevent multiple jumps in one frame.
            grounded = false;

            // Optionally, you can play a jump sound here if needed.
        }
        /// <summary>
